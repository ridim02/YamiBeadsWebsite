        ...
        <div class="bor10 m-t-50 p-t-43 p-b-40">
            ...
            <div class="tab01">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item p-b-10">
                        <a class="nav-link" data-toggle="tab" href="#reviews" role="tab" id="comment_count">Reviews
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                <div class="p-b-30 m-lr-15-sm">
                                                ...
                                                <div class="size-207">
                                                    ...
                                                    <span class="fs-18 cl11">
                                                        <a href="javascript:void(0)"
                                                            class="stext-109 cl8 hov-cl1 trans-04 delete_review"
                                                            attr_id=<?php echo $row_comment['id']; ?>> Delete Review </a>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <form method="post" class="w-full" id="review_submit">
                                        ...
                                        <input type="hidden" name="user_id" id="detail_id"
                                            value="<?php echo $detail_id; ?>">
                                        ...
                                        <button
                                            ...
                                            name="review_submit" id="review_count">
                                            Submit
                                        </button>
                                    </form>
                                </div>
